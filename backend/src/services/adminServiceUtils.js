...
const DEFAULT_SERVICE_PLANS = [
  ...
  },
  {
    ...
    included_features: ['normal_audio_room', 'normal_video_group_chat', 'group_voice_chat', 'one_to_one_voice_calling', 'one_to_one_video_calling', 'message_chat', 'picture_message', 'room_roles', 'mic_layout_picker', 'mic_seat_locks', 'private_room_password', 'rtc_connection_indicator'],
  },
  {
    code: 'pro',
    name: 'Pro RTC',
    ...
    included_features: ['normal_audio_room', 'youtube_audio_room', 'noise_cancellation', 'voice_changer', 'audio_player', 'youtube_player', 'one_to_one_voice_calling', 'group_voice_chat', 'normal_video_group_chat', 'live_video_pk', 'one_to_one_video_calling', 'solo_video_live', 'screen_share', 'video_filter_beauty', 'message_chat', 'picture_message', 'premium_reactions', 'room_roles', 'mic_layout_picker', 'mic_seat_locks', 'private_room_password', 'room_theme', 'room_share', 'admin_panel_analytics', 'rtc_connection_indicator'],
  },
  {
    code: 'enterprise',
    name: 'Enterprise RTC',
    description: 'Full RTC service with multi-app access controls, AI security, client-company billing analytics, moderation history, and global monitoring.',
...
const FEATURE_CATALOG = [
  ...
  { key: 'audio_player', group: 'Audio Features', label: 'Audio playlist player' },
  { key: 'youtube_player', group: 'Audio Features', label: 'YouTube player panel' },
  ...
  { key: 'picture_message', group: 'Common', label: 'Picture messages' },
  { key: 'premium_reactions', group: 'Common', label: 'Premium emoji/reaction packs' },
  { key: 'room_roles', group: 'Common', label: 'Room owner, admin, moderator limits' },
  { key: 'mic_layout_picker', group: 'Common', label: 'Mic layout picker' },
  { key: 'mic_seat_locks', group: 'Common', label: 'Mic seat lock controls' },
...
const SERVICE_FLOW = [
  ...
  },
  {
    ...
    owner: 'Superadmin',
    output: 'App key, API key, access token, and allowed domains for the client app.',
  },
  {
