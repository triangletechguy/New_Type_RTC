...
CREATE TABLE IF NOT EXISTS users (
    ...
    message_privacy ENUM('everyone', 'followers', 'nobody') NOT NULL DEFAULT 'everyone',
    private_live_invitation TINYINT(1) NOT NULL DEFAULT 1,
    hide_sensitive_content TINYINT(1) NOT NULL DEFAULT 1,
