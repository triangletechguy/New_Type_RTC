...
const searchRecommendations = [
  ...
  { id: 'rec-4', name: 'BuzzCast Team', detail: 'Welcome to the Buzz...', unread: 1 },
]
...
const dmThreads = [
  ...
  { id: 'buzz', name: 'BuzzCast', time: 'Wednesday 01:27', preview: 'Welcome to the Buzz...', unread: 1 },
]
...
const initialDmMessages = {
  ...
  jennifer: [],
  friend: [],
  buzz: [{ id: 'welcome', author: 'BuzzCast', body: 'Welcome to the BuzzCast-style lobby.', mine: false }],
}
...
const faqTopics = [
  ...
  'How to upgrade the BuzzCast app',
...
function BuzzLogo() {
  return (
    <div className="buzzcast-logo">
      <div className="buzzcast-logo-mark">BC</div>
      <div>
    ...
    return (
      <section className="buzzcast-room-preview">
        ...
        <aside className="buzzcast-live-chat">
          <p>Be polite and respectful. Any vulgar, violent, or private transaction behavior is strictly prohibited in BuzzCast. Please speak in a civilized manner.</p>
      ...
      {showInstall ? (
        <div className="buzzcast-modal-backdrop">
          <section className="buzzcast-install-modal">
            ...
            <div>
              <div className="buzzcast-logo-mark">BC</div>
              <span><strong>BuzzCast</strong><small>www.buzzcast.com</small></span>
            </div>
            <footer>
