...
export const emojiCategories = [
  ...
  },
  {
    id: 'travel',
    label: 'Travel',
    emojis: splitEmojiList('🚗 🚕 🚙 🚌 🏎️ 🚓 🚑 🚒 🚐 🛻 🚚 🚛 🚜 🛴 🚲 🛵 🏍️ 🚨 🚔 🚍 🚘 🚖 🚃 🚄 🚅 🚈 🚂 🚆 🚇 🚊 🚉 ✈️ 🛫 🛬 🚀 🛸 🚁 ⛵ 🚤 🚢 ⚓ ⛽ 🚧 🚦 🗺️ 🗽 🗼 🏰 🏟️ 🎡 🎢 ⛲ 🏖️ 🏝️ ⛰️ 🏔️ 🗻 🏕️ 🏠 🏢 🏥 🏦 🏨 🏪 🏫'),
  },
  {
    id: 'objects',
    label: 'Objects',
    emojis: splitEmojiList('⌚ 📱 💻 ⌨️ 🖥️ 🖨️ 🖱️ 🕹️ 💽 💾 💿 📷 📸 📹 🎥 📞 ☎️ 📟 📺 📻 🎙️ 🧭 ⏱️ ⏰ ⌛ 🔋 🔌 💡 🔦 💸 💵 💳 💎 ⚖️ 🧰 🔧 🔨 ⚙️ 🧲 🔮 🔭 🔬 🩹 💊 💉 🧬 🧪 🌡️ 🧹 🧺 🚽 🚿 🛁 🔑 🚪 🪑 🛋️ 🛏️ 🧸 🖼️ 🛍️ 🛒 🎁 🎈 🎀 🎊 🎉'),
  },
  {
    id: 'symbols',
    label: 'Symbols',
    emojis: splitEmojiList('✅ ☑️ ✔️ ❌ ❎ ➕ ➖ ➗ ✖️ ♾️ ⁉️ ‼️ ❓ ❔ ❕ ❗ 💲 ⚕️ ♻️ 🔱 ⭕ 🛑 ⛔ 🚫 💯 🔞 📶 📴 ♀️ ♂️ ✳️ ❇️ ✴️ 🆚 🅰️ 🅱️ 🆎 🅾️ 🆒 🆓 ℹ️ 🆔 🆕 🆗 🆘 🆙 🔴 🟠 🟡 🟢 🔵 🟣 🟤 ⚫ ⚪ 🟥 🟧 🟨 🟩 🟦 🟪 ⬛ ⬜ 🔶 🔷 🔸 🔹 🔺 🔻 💠'),
  },
  {
    id: 'nature',
    label: 'Nature',
    emojis: splitEmojiList('🌵 🎄 🌲 🌳 🌴 🌱 🌿 ☘️ 🍀 🍃 🍂 🍁 🍄 🌾 💐 🌷 🌹 🌺 🌸 🌼 🌻 🌞 🌝 🌛 🌜 🌚 🌕 🌖 🌗 🌘 🌑 🌒 🌓 🌔 🌙 🌎 🌍 🌏 🪐 💫 ⭐ 🌟 ✨ ⚡ ☄️ 💥 🔥 🌪️ 🌈 ☀️ 🌤️ ⛅ 🌥️ ☁️ 🌧️ ⛈️ 🌨️ ❄️ ⛄ 💨 💧 💦 ☔ 🌊'),
  },
  {
    id: 'flags',
    label: 'Flags',
    emojis: splitEmojiList('🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 🏴‍☠️ 🇺🇸 🇨🇦 🇲🇽 🇧🇷 🇦🇷 🇨🇱 🇨🇴 🇵🇪 🇬🇧 🇮🇪 🇫🇷 🇩🇪 🇮🇹 🇪🇸 🇵🇹 🇳🇱 🇧🇪 🇨🇭 🇦🇹 🇸🇪 🇳🇴 🇩🇰 🇫🇮 🇵🇱 🇺🇦 🇬🇷 🇹🇷 🇮🇳 🇵🇰 🇧🇩 🇨🇳 🇯🇵 🇰🇷 🇸🇬 🇹🇭 🇻🇳 🇵🇭 🇮🇩 🇲🇾 🇦🇺 🇳🇿 🇿🇦 🇳🇬 🇪🇬 🇰🇪 🇸🇦 🇦🇪'),
  },
]
